 ...
 */
public class Main {
    private static Log log = LogFactory.getLog(com.antzuhl.mall.pay.Main.class);
    ...
    public static void main(String[] args) {
        com.antzuhl.mall.pay.Main main = new com.antzuhl.mall.pay.Main();
    ...
    public void test_monitor_schedule_logic() {
        // 启动交易保障线程
        com.antzuhl.mall.pay.DemoHbRunner demoRunner = new com.antzuhl.mall.pay.DemoHbRunner(monitorService);
    ...
    public void test_trade_precreate() {
        ...
        String subject = "阿玛尼门店当面付扫码消费";

        // (必填) 订单总金额，单位为元，不能超过1亿元
        // 如果同时传入了【打折金额】,【不可打折金额】,【订单总金额】三者,则必须满足如下条件:【订单总金额】=【打折金额】+【不可打折金额】
        String totalAmount = "12441.50";
